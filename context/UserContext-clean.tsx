...
export function UserProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const loadUserData = async () => {
      console.log("🔄 MiniKit Context Debug (Clean):", { 
        hasContext: !!context,
      ...
      try {
        ...
        // Note: We'll get wallet address through other means (useAccount hook or transaction callbacks)
        // MiniKit context primarily provides user identity information
  ...
  // Function to update wallet address when it becomes available
